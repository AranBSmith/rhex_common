...
namespace rhex_controller {
    ...
    public:
        ...
        void set_parameters(const std::vector<double>& ctrl)
        {
            ...
            _k = ctrl[1];
            _sigma = ctrl[2];
            _stance_angle = ctrl[3]; // 0-1
            _stance_offset = ctrl[4]; // 0-1
            _last_time = 0;
            _dt = 0.0;
            ...
            _k_weights = std::vector<double>(DOF, 20);
